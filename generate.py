...
def generate_answers_file(test_descriptions_file_path, answer_file_path):
    ...
    test_descriptions = test_descriptions.head(10)
...
def run_benchmark(benchmark_set):
    ...
    for benchmark in benchmark_set:
        test_descriptions_file_path = 'data/local-testsets/{}-descriptions.txt'.format(benchmark)
        answer_file_path = 'data/local-testsets/{}-answers.txt'.format(benchmark)
        generate_answers_file(test_descriptions_file_path, answer_file_path)
...
if args.mode == 'interactive':
    ...
    generate_answers_file('data/test_descriptions.csv', 'submission/submission.csv')
